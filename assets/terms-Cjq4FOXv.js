import{q as t,f as r}from"./index-DumrJyPT.js";const u=t("terms",()=>{const a=r(""),l=r(!1),o=r(null),s=async()=>{l.value=!0,o.value=null;try{const i=await fetch("undefined/api/terms");if(!i.ok)throw new Error(`HTTP error! status: ${i.status}`);const e=await i.json();if(!e.success||!e.data)throw new Error(e.error||"Failed to fetch terms");return a.value=e.data.content,e.data.content}catch(i){return a.value=n(),o.value=i instanceof Error?i.message:"Unknown error occurred",a.value}finally{l.value=!1}},n=()=>`
    ...
    `;return{termsContent:a,isLoading:l,error:o,fetchTerms:s,clearError:()=>{o.value=null}}});export{u};
//# sourceMappingURL=terms-Cjq4FOXv.js.map
